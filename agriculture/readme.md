...
| **compliance** | audit_oversight | audit_finding | ✅ | ❌ | Domain not in MVM |
...
| **crop** | field_operations | fertilization_event | ✅ | ✅ |  |
...
| **customer** | account_management | account | ✅ | ✅ |  |
...
| **equipment** | field_operations | field_operation | ❌ | ✅ | MVM only (stub or new) |
...
| **finance** | enterprise_planning | capital_project | ✅ | ✅ |  |
...
| **inventory** | commodity_fulfillment | lot_allocation | ✅ | ❌ | Excluded from MVM |
...
| **invoice** | adjustment_management | credit_memo | ✅ | ❌ | Excluded from MVM |
...
| **land** | field_operations | soil_sample | ❌ | ✅ | MVM only (stub or new) |
...
| **livestock** | animal_health | animal_hold | ✅ | ❌ | Excluded from MVM |
...
| **procurement** | catalog_compliance | budget | ✅ | ✅ |  |
...
| **product** | input_catalog | agrochemical_practice_compatibility | ✅ | ❌ | Excluded from MVM |
...
| **quality** | compliance_auditing | corrective_action | ✅ | ✅ |  |
...
| **research** | germplasm_development | accession | ✅ | ❌ | Domain not in MVM |
...
| **sales** | contract_administration | contract | ✅ | ✅ |  |
...
| **supply** | freight_movement | bill_of_lading | ✅ | ✅ |  |
...
| **sustainability** | emission_management | carbon_credit | ✅ | ❌ | Domain not in MVM |
...
| **weather** | agronomic_analytics | climate_risk_indicator | ✅ | ❌ | Domain not in MVM |
...
| **workforce** | compensation_benefits | benefit_enrollment | ✅ | ❌ | Excluded from MVM |

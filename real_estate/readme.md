...
| **brokerage** | agent_operations | broker_license | ✅ | ✅ |  |
...
| **compliance** | incident_resolution | fair_housing_record | ✅ | ✅ |  |
...
| **development** | contract_administration | change_order | ✅ | ✅ |  |
...
| **finance** | budget_planning | budget | ❌ | ✅ | MVM only (stub or new) |
...
| **insurance** | claims_management | adjuster | ✅ | ❌ | Domain not in MVM |
...
| **investment** | capital_structure | capital_account | ✅ | ✅ |  |
...
| **lease** | contract_administration | amendment | ✅ | ✅ |  |
...
| **maintenance** | asset_management | contract_asset_coverage | ❌ | ✅ | MVM only (stub or new) |
...
| **marketing** | brand_strategy | audience_segment | ✅ | ❌ | Excluded from MVM |
...
| **owner** | capital_transactions | capital_contribution | ✅ | ✅ |  |
...
| **property** | asset_registry | address | ✅ | ✅ |  |
...
| **reference** | asset_classification | amenity_type | ✅ | ✅ |  |
...
| **tenant** | identity_management | corporate_entity | ✅ | ✅ |  |
...
| **transaction** | sale_execution | auction | ✅ | ❌ | Excluded from MVM |
...
| **valuation** | appraisal_services | appraisal | ✅ | ✅ |  |
...
| **workforce** | compensation_administration | applicant | ✅ | ❌ | Domain not in MVM |
